...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary" id="header" style="user-select: auto;">
  <a class="navbar-brand" href="/project" style="user-select: auto;">ProjectHub</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarColor01" aria-controls="navbarColor01" aria-expanded="false" aria-label="Toggle navigation" style="user-select: auto;">
	...
	<form action="/search" method="post" class="form-inline my-2 my-lg-0" style="user-select: auto;">
      <input class="form-control mr-sm-2" type="text" placeholder="Search" style="user-select: auto;">
      <button id="search" class="btn btn-secondary my-2 my-sm-0" type="submit" style="user-select: auto;">Search</button>
    </form>
